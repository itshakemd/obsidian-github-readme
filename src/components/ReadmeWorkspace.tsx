...
interface Props { selectedRepo: RepoInfo | null; readme: ReadmeData | null; readmeLoading: boolean; readmeError: string; readmeDraft: string; setReadmeDraft: (v: string) => void; editorKey: number; renderMarkdown: (markdown: string, el: HTMLElement) => Promise<() => void>; }
export default function ReadmeWorkspace({ selectedRepo, readme, readmeLoading, readmeError, readmeDraft, setReadmeDraft, editorKey, renderMarkdown }: Props) {
